    ...
    <div class="container d-flex justify-content-center">
      <div class="card mt-5 px-3 py-4">
        ...
        <div class="media mt-4 pl-2">
          ...
          <img src="./images/mypickuppoint.png" class="mr-3" height="35px"  style="width: 115px;" />
          </div>
        </div>
        <div class="media mt-3 pl-2">
            ...
            <div class="col-12">
                  <label for="inputAddress" class="form-label">Order ID Number</label>
                  <input type="text" class="form-control" name="number" placeholder="Order ID Number">
                </div>
                <div class="col-12">
